...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->txt_usuario->Location = System::Drawing::Point(113, 120);
			...
			this->txt_contrasena->Font = (gcnew System::Drawing::Font(L"Nirmala UI", 13.8F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->txt_contrasena->Location = System::Drawing::Point(113, 277);
			...
			this->label2->Location = System::Drawing::Point(119, 247);
			...
			this->btn_ingresar->Location = System::Drawing::Point(102, 383);
			...
			this->label3->Size = System::Drawing::Size(379, 31);
			this->label3->TabIndex = 5;
			this->label3->Text = L"Sistema de Gestión de Estudiantes";
			...
			this->ClientSize = System::Drawing::Size(468, 492);
...
/*/private: System::Void btn_ingresar_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	dataReader = cursor->ExecuteReader();
			   if (dataReader->Read()) {
				   ...
				   this->conn = gcnew MySqlConnection("datasource=localhost; username=root; password=123; database=heacker;");
...
private: System::Void btn_ingresar_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	if (String::IsNullOrEmpty(usuario) || String::IsNullOrEmpty(contrasena)) {
		MessageBox::Show(L"Por favor, ingrese su usuario y contraseña.");
		txt_usuario->Text = "";
		txt_contrasena->Text = "";
		return;
	}

	String^ sql = "SELECT * FROM registros WHERE usuario = '" + usuario + "' AND contrasena = '" + contrasena + "'";
	MySqlCommand^ cursor = gcnew MySqlCommand(sql, conn);
	MySqlDataReader^ dataReader;
	...
	try {
		...
		if (dataReader->Read()) {
			...
			MessageBox::Show(L"Usuario o contraseña incorrectos. Por favor, ingrese sus credenciales correctas.");
			txt_usuario->Text = "";
			txt_contrasena->Text = "";
			txt_usuario->Focus();
		}
